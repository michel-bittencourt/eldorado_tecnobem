...
if(isset($_SESSION['comiss1'])){
    ...
    $historico = "RECEBIMENTO DE COMISSÃO SOBRE CARGA COMPRADOR: ";
    $soma = 0;
    $i=0;
    foreach ($_SESSION['comiss1'] as $value) {
        ...
        $sql1 = "UPDATE ordem_carregamento SET lancado_comiss1 = 's' WHERE id_ordem = ".$value['id'];
    ...
    $sql2 = "INSERT INTO financeiro (data_cad, tipo, id_fornec, id_comprador, id_vendedor, id_transp, vencimento, valor, acrescimos, descontos, descri, data_pgto, valor_pgto, id_ccusto, id_conta_receber, situacao) 
            VALUES ('$data_cad', '$tipo', '0', '$id_comprador', '0', '0', '$vencimento', '$valor', '0', '0', '$descri', '0000-00-00', '0', '$id_ccusto', '$id_conta', '$situacao')";
    ...
    echo "Nenhum dado armazenado para comissão Comprador";
}
